...
public class TutorialCrab extends JPanel {
	...
	BufferedImage upLeft = ImageManager.get(IMAGES.MENU_CRAB1);
	BufferedImage upRight = ImageManager.get(IMAGES.MENU_CRAB2);
	BufferedImage downLeft = ImageManager.get(IMAGES.MENU_CRAB3);
	BufferedImage downRight = ImageManager.get(IMAGES.MENU_CRAB4);
